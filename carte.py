...
class Carte:
    def __init__(self, jeu):
        ...
        self.carte = [
            ...
            [1, _, _, _, _, _, _, _, _, _, _, _, _, 1, _, _, 1],
            [1, _, 1, 1, _, _, _, _, _, _, 1, 1, _, 1, _, _, 1],  # Ici on dessine la carte du jeu
            [1, _, 1, 1, _, _, 1, _, _, _, _, _, _, 1, _, _, 1],
            [1, _, _, _, _, _, 1, _, 1, 1, _, _, _, 1, _, _, 1],
            [1, _, _, _, _, _, 1, _, _, _, _, _, _, 1, _, _, 1],
            [1, _, 1, 1, _, _, 1, _, _, _, _, 1, 1, 1, _, _, 1],
